...
<form action="changememberInfo.do" method="post" enctype="multipart/form-data">
	<div class="container">
		<label><b>아이디</b></label>
			<input type="text" id="memberId" name="memberId" maxlength="20" value="${param.memberId}"disabled>
		...
		<label><b>이름</b></label>
			<input type="text" id="newName" name="newName" maxlength="20" value="${param.memberName}" required>
